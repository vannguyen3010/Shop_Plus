...
namespace ThreeF_WebPortal.Controllers
{
    public class CommonController : Controller
    {
      ...
      /*  [AllowAnonymous]*/
        //public async Task<JsonResult> GetProvincesByCountry(string countryId = "1")
        //{
        //    var provinces = await _s_Address.getListProvinceByCountryId<List<M_Province>>(countryId);
